        ...
        if (!nodes[0]?.parent_task) {
            const headerHTML = `
               <div class="task-headers" style="
                   ...
                   pointer-events: none;
               ">
                   <div style="width: 125px; text-align: left; font-weight: 500; pointer-events: auto;">Type</div>
                   <div style="width: 135px; text-align: center; font-weight: 500; pointer-events: auto;">Status</div>
                   <div style="width: 120px; text-align: center; font-weight: 500; pointer-events: auto;">Allocated</div>
                   <div style="width: 120px; text-align: center; font-weight: 500; pointer-events: auto;">Amount</div>
                   <div style="width: 120px; text-align: right; font-weight: 500; pointer-events: auto;">Current Amount</div>
               </div>
`
            ...
            for (let task of r.message) {
                ...
                const displayHTML = `
                    <div class="balance-area" style="
                        ...
                        gap: 0;
                    ">
                        <div style="width: 120px; text-align: left; padding-right: 20px;">${task.custom_release_budget_type || 'N/A'}</div>
                        <div style="width: 160px; text-align: center; padding-right: 20px;">${task.custom_substatus || 'N/A'}</div>
                        <div style="width: 100px; text-align: center; padding-right: 28px;">${task.custom_release_allocated_amount || '0'}</div>
                        <div style="width: 130px; text-align: center; padding-right: 15px;">${task.custom_release_amount || '0'}</div>
                        <div style="width: 100px; text-align: right; background-color: ${currentAmountColor}; color: white; padding: 2px 8px; border-radius: 3px;">${task.custom_total_budget_allocated || '0'}</div>
                    </div>
                `;
